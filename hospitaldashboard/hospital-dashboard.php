             ...
             <div class="col-sm-9 col-xs-12 content pt-3 pl-0 m-0" style="height:100vh;">
                ...
                <div class="container">
                    <div class="d-row">
                        ...
                        $res = mysqli_query($conn,$qry);
                        $child_count =mysqli_num_rows($res);
                        
                        ?>
                            <div class="number"><?php  echo $child_count  ?></div>
                            <div class="cardname">Children</div>
                        </div>
                        <div class="d-col">
                        ...
                        $res = mysqli_query($conn,$qry);
                        $hospital_count =mysqli_num_rows($res);
                        
                        ?>
                             <div class="number"><?php  echo $hospital_count  ?></div>
                            <div class="cardname">Hospitals</div>
                        </div>
                        <div class="d-col">
                    <?php  
                        ...
                        $res = mysqli_query($conn,$qry);
                        $feedback_count =mysqli_num_rows($res);
