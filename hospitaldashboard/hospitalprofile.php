            ...
            <div class="col-sm-3 col-xs-6 sidebar pl-0">
                <div class="inner-sidebar mr-3">
                    ...
                    <div class="avatar text-center">
                        ...
                        <img src="<?php echo $row['h_image'];?>" alt="" class="rounded-circle" />

                        </a>
                        <p><strong><?php echo $row['h_name']  ?></strong></p>
                        <span class="text-primary small"><strong><?php echo $row['h_email']  ?></strong></span>
                    </div>
                    <!--Image Avatar-->
