    ...
    <table class="table table-bordered table-striped mt-0" id="childList">
        ...
        <tbody>
            ...
            $qry = "
                ...
                INNER JOIN child_tbl 
                    ON appointment_tbl.child_id = child_tbl.child_id    
                INNER JOIN hospital_tbl 
                    ON appointment_tbl.hospital_id = hospital_tbl.hospital_id 
                INNER JOIN vaccines_tbl 
                    ON appointment_tbl.v_id = vaccines_tbl.v_id WHERE appointment_tbl.parent_id = " . intval($_SESSION['parent_session']); 
