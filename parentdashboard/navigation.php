 <div class="sidebar-menu-container">
                        <ul class="sidebar-menu mt-4 mb-4">
                             <li class="parent">
                                <a href="dashboard.php" class=""><i class="fas fa-home mr-3"></i>
                                    <span class="none">Dashboard</i></span>
                                </a>
                            ...
                            <li class="parent">
                                <a href="/VMS/home.php" target="_blank" class=""><i class=" fa-solid fa-globe mr-3"></i>
                                    <span class="none">Website<i class=" pull-right align-bottom"></i></span>
                                </a>
