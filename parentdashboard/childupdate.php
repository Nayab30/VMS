 ...
 <body>
    ...
    <div class="container-fluid">
        ...
        <div class="row main-content">
            ...
            <!--Content right-->
          <div class="container">
            <div><h1 class="text-center m-4 " style="color:var(--text-color2);">Update Child details </h1></div>
             <?php
            
                $qry="SELECT * FROM child_tbl  WHERE child_id = $_GET[id] ";
                $res= mysqli_query($conn,$qry);
...
<form action=""  method ="POST" class="mx-5 ">
  ...
  <div class="mb-3 mt-3">
    ...
    <input type="text" class="form-control bg-light" value="<?php echo $row['c_name']?>"  name="name">
  </div>
  <div class="mb-3">
    <label for="" class="form-label">Father's Name:</label>
    <input type="text" class="form-control" value="<?php echo $row['c_fathername']?>"  name="fname">
  </div>
    <div class="mb-3">
    <label for="" class="form-label">Child Age:</label>
    <input type="text" class="form-control" value="<?php echo $row['c_age']?>"  name="age">
  </div>
